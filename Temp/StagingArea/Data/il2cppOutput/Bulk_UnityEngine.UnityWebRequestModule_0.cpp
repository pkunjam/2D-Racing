...
extern "C" IL2CPP_METHOD_ATTR String_t* WebRequestUtils_MakeUriString_m5693EA04230335B9611278EFC189BD58339D01E4 (Uri_tF93A2559917F312C27D9DEAC7CAE4400D3A40F1E * ___targetUri0, String_t* ___targetUrl1, bool ___prependProtocol2, const RuntimeMethod* method)
{
	...
	}
	{
		...
		Il2CppChar L_10 = String_get_Chars_m0FE525C2D5B2F1291870A8AEE594F164F5621393(L_7, ((int32_t)il2cpp_codegen_add((int32_t)L_9, (int32_t)1)), /*hidden argument*/NULL);
	...
	}
	{
		...
		StringBuilder__ctor_m3048A515E1D314060733882877628701D80C16C8(L_14, L_11, L_13, /*hidden argument*/NULL);
		V_1 = L_14;
		StringBuilder_t * L_15 = V_1;
		StringBuilder_Append_m1F484B542C4F3C021CC03CFC09FE58A360ED4770(L_15, ((int32_t)58), /*hidden argument*/NULL);
		String_t* L_16 = V_0;
		IL2CPP_RUNTIME_CLASS_INIT(String_t_il2cpp_TypeInfo_var);
		bool L_17 = String_op_Equality_m63C6C48ECFB31D323F34FDE36794C6C384073A55(L_16, _stringLiteralF92E777F4341930BAD9B2422283C4680D00DBC06, /*hidden argument*/NULL);
		if (!L_17)
		{
			goto IL_00db;
		}
	...
	{
		Uri_tF93A2559917F312C27D9DEAC7CAE4400D3A40F1E * L_18 = ___targetUri0;
		String_t* L_19 = Uri_get_AbsolutePath_m1041BB4A254CCBAE0E2BC7B47570180E6A2621AE(L_18, /*hidden argument*/NULL);
		V_2 = L_19;
		String_t* L_20 = V_2;
		bool L_21 = String_Contains_m7CC0FCABE68C2CD560CA2BB2A499B4E47DFEA1F0(L_20, _stringLiteral4345CB1FA27885A8FBFE7C0C830A592CC76A552B, /*hidden argument*/NULL);
		if (!L_21)
		{
			goto IL_007c;
		}
...
IL_007c:
	{
		String_t* L_24 = V_2;
		bool L_25 = String_StartsWith_m7B83E0D4961FE9321291479F87C4160079C1774F(L_24, _stringLiteral947518D877FB275850A375D795BE6A44C27AB526, /*hidden argument*/NULL);
		if (!L_25)
		{
			goto IL_00c7;
		}
	...
	{
		String_t* L_28 = V_2;
		Il2CppChar L_29 = String_get_Chars_m0FE525C2D5B2F1291870A8AEE594F164F5621393(L_28, 6, /*hidden argument*/NULL);
	...
	}
	{
		...
		StringBuilder_Append_m402C4CFC4FCEC22D0A372742BC40DF2224C41F86(L_30, _stringLiteralA91E4897CA9F429677AFC57ED00D90DE8D3C7001, /*hidden argument*/NULL);
		StringBuilder_t * L_31 = V_1;
		String_t* L_32 = V_2;
		String_t* L_33 = String_Substring_m57FDC697BFC054AD210D35CE4825B770DF760F12(L_32, 5, /*hidden argument*/NULL);
		StringBuilder_Append_m402C4CFC4FCEC22D0A372742BC40DF2224C41F86(L_31, L_33, /*hidden argument*/NULL);
		goto IL_00cf;
	}
...
IL_00c7:
	{
		...
		String_t* L_35 = V_2;
		StringBuilder_Append_m402C4CFC4FCEC22D0A372742BC40DF2224C41F86(L_34, L_35, /*hidden argument*/NULL);
	}
...
IL_00db:
	{
		...
		Uri_tF93A2559917F312C27D9DEAC7CAE4400D3A40F1E * L_39 = ___targetUri0;
		String_t* L_40 = Uri_get_PathAndQuery_m30CFB76360DC78FCF7B2B5792B8F3EB4B0565B21(L_39, /*hidden argument*/NULL);
		StringBuilder_Append_m402C4CFC4FCEC22D0A372742BC40DF2224C41F86(L_38, L_40, /*hidden argument*/NULL);
		StringBuilder_t * L_41 = V_1;
		Uri_tF93A2559917F312C27D9DEAC7CAE4400D3A40F1E * L_42 = ___targetUri0;
		String_t* L_43 = Uri_get_Fragment_m8A0CF0DAE7681721AD6D9B0A014C27597A708609(L_42, /*hidden argument*/NULL);
		StringBuilder_Append_m402C4CFC4FCEC22D0A372742BC40DF2224C41F86(L_41, L_43, /*hidden argument*/NULL);
...
IL_0101:
	...
	{
		Uri_tF93A2559917F312C27D9DEAC7CAE4400D3A40F1E * L_48 = ___targetUri0;
		String_t* L_49 = Uri_get_OriginalString_m126CB1FA8F56E0B9118E38A0C317280AE707B094(L_48, /*hidden argument*/NULL);
		V_3 = L_49;
		goto IL_0129;
	}
...
IL_011d:
	{
		Uri_tF93A2559917F312C27D9DEAC7CAE4400D3A40F1E * L_50 = ___targetUri0;
		String_t* L_51 = Uri_get_AbsoluteUri_m37247BEBAC92BE67B2C93653120447E7A94977C6(L_50, /*hidden argument*/NULL);
		V_3 = L_51;
		goto IL_0129;
	}
